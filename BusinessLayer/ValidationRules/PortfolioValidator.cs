...
namespace BusinessLayer.ValidationRules
{
    public class PortfolioValidator : AbstractValidator<Portfolio>
    {
        public PortfolioValidator()
        {
            ...
            RuleFor(x => x.Price).NotEmpty().WithMessage("Görsel alanı boş geçilemez.");
            ...
            RuleFor(x => x.Name).MaximumLength(5).WithMessage("Proje adı en çok 100 karakterden oluşmak zorundadır.");
        }
    }
}
